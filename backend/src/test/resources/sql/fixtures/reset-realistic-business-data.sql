-- 本地开发环境单项目演示数据重置夹具（原文件名：20260719_reset_realistic_test_data.sql）
--
...
DELETE FROM quality_issue_export_job_item;
DELETE FROM quality_issue_export_job;
DELETE FROM quality_issue_log;
DELETE FROM quality_issue;
DELETE FROM quality_weekly_inspection_draft_item;
DELETE FROM quality_weekly_inspection;
DELETE FROM quality_weekly_reminder_setting;
...
ALTER TABLE quality_issue_export_job_item AUTO_INCREMENT = 1;
ALTER TABLE quality_issue_export_job AUTO_INCREMENT = 1;
ALTER TABLE quality_issue_log AUTO_INCREMENT = 1;
ALTER TABLE quality_issue AUTO_INCREMENT = 1;
ALTER TABLE quality_weekly_inspection_draft_item AUTO_INCREMENT = 1;
ALTER TABLE quality_weekly_inspection AUTO_INCREMENT = 1;
ALTER TABLE quality_weekly_reminder_setting AUTO_INCREMENT = 1;
