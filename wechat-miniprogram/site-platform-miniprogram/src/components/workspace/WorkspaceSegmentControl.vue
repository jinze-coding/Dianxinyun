...
.segment-button::after { border: 0; }
.segment-button:active { transform: scale(0.97); }
.segment-button.active { color: var(--segment-accent); font-weight: 700; }
...
@media (prefers-reduced-motion: reduce) {
  .segment-indicator,
  .segment-button { transition-duration: 1ms; }
}
</style>
