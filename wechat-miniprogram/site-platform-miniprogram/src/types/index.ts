...
export type TodoType = 'INSPECTION' | 'EDGE_INSPECTION_TASK' | 'EDGE_INSPECTION_RECTIFICATION' | 'EDGE_INSPECTION_REVIEW' | 'REVIEW' | 'RECTIFICATION' | 'RECTIFICATION_ASSIGN' | 'RECHECK' | 'RECHECK_ASSIGN' | 'SEAL_APPROVAL' | 'DOCUMENT_RECEIPT';
