  ...
  <view class="shell">
    ...
    <view class="content">
      ...
      <view v-if="status" class="status-card">
        ...
        <button v-if="status.status === 'APPROVED'" class="login-link" @tap="backToLogin">返回登录</button>
