    ...
    <scroll-view class="workspace-scroll" scroll-y enable-flex :style="scrollStyle">
      <view class="committee-content">
        <view class="committee-context">
          <text class="committee-title">{{id?'修改本人巡检':'上报巡检'}}</text>
        ...
        <view class="committee-card">
          ...
          <view class="committee-actions">
            <button class="committee-button committee-action-button" @tap="capture">现场拍摄</button>
            <button class="committee-button committee-action-button" @tap="choose('album')">相册</button>
            <button class="committee-button committee-action-button" @tap="choose('chat')">选择文件</button>
          </view>
          <view v-for="item in files" :key="item.key" class="committee-file">
            <view class="committee-file-copy">
